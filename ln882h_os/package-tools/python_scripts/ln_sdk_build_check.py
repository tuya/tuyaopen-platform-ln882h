...
def main():
    ...
    keil_proj_list = [
        "project/armcc_lib_build/ln882h_ble_lib",   # MUST be provided!!!
        "project/armcc_lib_build/ln882h_wifi_lib",  # MUST be provided!!!
        ...
        # ble_mcu_prf_battery
        "project/ble_mcu_prf_battery/keil_ln882h_dev",
        # ble_mcu_prf_hid_mouse
        "project/ble_mcu_prf_hid_mouse/keil_ln882h_dev",
        # ble_mcu_scan
