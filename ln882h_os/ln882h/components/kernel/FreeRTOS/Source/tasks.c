...
#include "lwip/err.h"
    ...
    LOG(LOG_LVL_INFO, "%s, name: %s, priority: %d, stack size: %d\r\n",
            __func__, pcName, uxPriority, usStackDepth * 4);
...
#if (1 == LWIP_NETCONN_SEM_PER_THREAD)
            /* add by tuya */
            extern err_t lwip_socket_thread_cleanup(void *task);
