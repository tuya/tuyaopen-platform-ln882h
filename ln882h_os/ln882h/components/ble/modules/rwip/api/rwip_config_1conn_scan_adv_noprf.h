...
/***********************************************************
* Number of Resolution Address List 
***********************************************************/  
#define  CFG_RAL   1
...
/***********************************************************
* number of profile support. IMPORTANT!!!! 
***********************************************************/  
#define  CFG_NB_PRF 4  // if only netcfg profile for config network,it should be 1; Mesh also a profile.
...
#define BLE_PHY_1MBPS_SUPPORT                       1
#define BLE_PHY_2MBPS_SUPPORT                       0//1
#define BLE_PHY_CODED_SUPPORT                       1
#define BLE_STABLE_MOD_IDX_TX_SUPPORT               0
#define BLE_STABLE_MOD_IDX_RX_SUPPORT               0
